(() => {
  ...
  const projectTranslations = {
    ...
    project06: {
      kz: {category: 'Motion Design', description: 'Жаһандық ауқым мен кәсіби қызметтер туралы бренд-презентацияға арналған корпоративтік motion graphics. Ұстамды анимация мен анық визуалды иерархия ақпаратты түсінікті жеткізуге көмектеседі.'},
      ru: {category: 'Motion Design', description: 'Корпоративная motion-графика для бренд-презентации о глобальном присутствии и профессиональных услугах. Сдержанная анимация и ясная визуальная иерархия помогают понятно передать информацию.'}
    },
    still01: {
