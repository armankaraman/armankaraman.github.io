(() => {
  ...
  const ui = {
    kz: {
      ...
      education: 'Білім', educationSchool: 'University of Science and Technology Beijing (USTB), Бейжің, Қытай', educationDegree: 'Арт-дизайн мамандығы бойынша бакалавр дәрежесі · 2009–2013',
    ...
    en: {
      ...
      education: 'Education', educationSchool: 'University of Science and Technology Beijing (USTB), Beijing, China', educationDegree: 'Bachelor’s Degree in Art Design · 2009–2013',
    ...
    ru: {
      ...
      education: 'Образование', educationSchool: 'University of Science and Technology Beijing (USTB), Пекин, Китай', educationDegree: 'Степень бакалавра по специальности «Арт-дизайн» · 2009–2013',
