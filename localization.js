(() => {
  ...
  const ui = {
    kz: {
      ...
      contact: 'Байланыс', contactIntro: 'Жоба, ынтымақтастық немесе басқа сұрақтар бойынша:', name: 'Аты', email: 'Email', message: 'Хабарлама', send: 'Жіберу', sending: 'Жіберілуде...', contactSuccess: 'Хабарлама жіберілді.', contactError: 'Хабарламаны жіберу мүмкін болмады. Қайта көріңіз.',
    ...
    en: {
      ...
      contact: 'Contact', contactIntro: 'For commissions, collaborations or inquiries:', name: 'Name', email: 'Email', message: 'Message', send: 'Send message', sending: 'Sending...', contactSuccess: 'Message sent successfully.', contactError: 'Something went wrong. Please try again.',
    ...
    ru: {
      ...
      contact: 'Контакты', contactIntro: 'По вопросам проектов, сотрудничества и другим запросам:', name: 'Имя', email: 'Email', message: 'Сообщение', send: 'Отправить', sending: 'Отправка...', contactSuccess: 'Сообщение отправлено.', contactError: 'Не удалось отправить сообщение. Попробуйте ещё раз.',
  ...
  const projectTranslations = {
    ...
    still06: {
      kz: {category: 'Мобильді қосымша интерфейсінің дизайны', description: 'Figma-да жасалған SilkPay мобильді қосымшасының интерфейс дизайны. Жобада қосымша экрандары, визуалды стиль және интерфейс элементтерінің орналасуы көрсетілген.'},
      ru: {category: 'Дизайн интерфейса мобильного приложения', description: 'Дизайн интерфейса мобильного приложения SilkPay в Figma. В проекте представлены экраны приложения, визуальный стиль и компоновка элементов интерфейса.'}
    }
  };
